...
-help                      Displays this help.
        ...
        <translation>使用方法: assistant [オプション]

-collectionFile file       デフォルトのコレクションファイルの代わりに、
                           指定したコレクションファイルを使用します
-showUrl url               指定したURLのドキュメントを表示します。
-enableRemoteControl       Assistantをリモートコントロール
                           できるようにします。
-show widget               &quot;コンテンツ&quot;,&quot;インデックス&quot;,&quot;ブックマーク&quot;
                           または &quot;検索&quot;にできる指定された
                           ドックウィジェットを表示します。
-activate widget           指定されたドックウィジェット &quot;コンテンツ&quot;,
                           &quot;インデックス&quot;,&quot;ブックマーク&quot; または &quot;検索&quot;
                           をアクティブにします。
-hide widget               指定されたドックウィジェット&quot;コンテンツ&quot;,
                           &quot;インデックス&quot;,&quot;ブックマーク&quot; または 
                           &quot;検索&quot;を非表示にします。
-register helpFile         指定されたヘルプ ファイル (.qch) 
                           を指定されたコレクション ファイルに
                           登録します。
-unregister helpFile       指定されたヘルプ ファイル (.qch) を
                           指定されたコレクション ファイルから
                           登録解除します。
-setCurrentFilter filter   フィルターをアクティブフィルターに設定します。
-remove-search-index       フルテキスト検索インデックスを削除します。
-rebuild-search-index      廃止されました。代わりに -remove-search-index を使用してください。
                           フルテキスト検索インデックスを削除します。
                           アシスタントの次回実行時に再構築されます。
-quiet                     エラーやステータスメッセージを
                           表示しません。
-help                      このヘルプを表示します。
</translation>
    </message>
...
<context>
    ...
    <message>
        ...
        <translation>登録済み文書</translation>
    </message>
    <message>
        <location/>
        <source>&lt;Filter&gt;</source>
